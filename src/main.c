...
static GOptionEntry opt_entries[] =
{
    ...
    { "filename", 'f', 0, G_OPTION_ARG_FILENAME, &deps_file,
        "Dependencies file generated by pbuild.py (make pbuilder)", NULL },
    { "cpu", 'c', 0, G_OPTION_ARG_INT, &cpu_num,
        "Max number of CPUs used to build. Default: automatic", NULL },
    { NULL }
};
...
int main(int argc, char *argv[]) 
{
    ...
    if (!deps_file) {
        pg_log(GP_ERR, "No dependencies JSON filename given. Aborting!");
